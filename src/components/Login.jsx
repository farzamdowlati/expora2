...
function Login() {
  ...
  const handleLogin = (e) => {
    ...
    if (username === 'test' && password === 'test') {
      // Successful login - redirect back to the card detail page
      ...
      <main className="flex items-center justify-center min-h-screen px-4">
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => navigate(-1)}
            className="mb-8 text-blue-600 hover:text-gray-800 transition-colors duration-300 font-professional flex items-center gap-2"
          >
            ← Back
          </motion.button>
          ...
          >
            <div className="text-center mb-8">
              <h2 className="text-3xl font-calligraphy text-blue-600 mb-2">
                Welcome Back
              </h2>
              <p className="text-gray-600 font-professional text-sm">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              <div>
                <label htmlFor="username" className="block text-gray-700 font-professional text-sm mb-2">
                  Username
                </label>
                <input
                  type="text"
                  ...
                  className="w-full px-4 py-3 bg-white/80 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-500 font-professional focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-300 transition-all duration-300"
                  required
                />
              </div>

              <div>
                <label htmlFor="password" className="block text-gray-700 font-professional text-sm mb-2">
                  Password
                </label>
                <input
                  type="password"
            ...
            <div className="mt-6 text-center space-y-2">
              <a href="#" className="block text-blue-600 hover:text-blue-800 transition-colors duration-300 font-professional text-sm">
                Forgot Password?
              </a>
              <div className="text-gray-500 font-professional text-sm">
            ...
            <div className="my-8 flex items-center">
              ...
              <span className="px-4 text-gray-500 font-professional text-sm">or continue with</span>
              <div className="flex-1 border-t border-gray-300"></div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <motion.button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white/80 border border-gray-300 rounded-lg text-gray-700 font-professional hover:bg-white hover:border-gray-400 transition-all duration-300"
              >
